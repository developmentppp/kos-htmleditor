...
//   global: boolean;
// }
// export type TFilterDefinitionType =
//   | "number"
//   | "string"
//   | "dropdown"
//   | "date"
...
// }
// export interface IModeTemporalFilterDefinition
//   extends ITemporalFilterDefinition {
//   type: "mode-date";
...
//   | ENotificationTopicLevel
//   | ENotificationLevelInherit;
...
//   | IContentEntry
//   | INotificationPushContentEntry
//   | INotificationInAppContentEntry;
...
//   setIdentities(identities: { id: number | null; uuid: string }): void;
//   get estimatedSize(): {
//     w: number;
//     h: number;
//   };
...
//   constructor(
//     initData?: IFormContainer,
//     type?: TFormContainerType,
//     submitLabel?: string
//   );
//   parseData(initData: IFormContainer): void;
//   resetIdentities(): void;
//   updateIdentitiesDeep(identities: { [id: string]: string }): void;
//   get data(): any;
...
//   flattenAllChildren(
//     level?: number,
//     excludeDataFields?: boolean,
//     asData?: boolean
//   ): (CFormContainer | CFormField)[];
...
//   get returnValueAsInteger():
//     | EReturnType.integer
//     | (EReturnType.integer | null)[]
//     | null;
...
//   setGeneratorValue(
//     generator: EReturnType | null,
//     value: any | any[]
//   ): EReturnType | EReturnType[] | null;
//   get isValid(): boolean;
...
//   createUuid(): void;
//   resetIdentities(): void;
//   setIdentities(properties: { id: string | null; uuid: string | null }): void;
